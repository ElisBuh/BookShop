...
import com.senla.exceptions.ControllerException;
import com.senla.exceptions.ApiError;
...
public class GlobalJavaExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({ControllerException.class, EntityNotFoundException.class})
    protected ResponseEntity<Object> handleEntityNotFoundEx(ControllerException ex, WebRequest request) {
