...
public class Builder {
    ...
    public void buildMenu() {
        ...
        rootMenuItems[4] = new MenuItem("Выход.", new Exit(), rootMenu);
    ...
    private Menu bookMenu() {
        ...
        bookMenuItems[7] = new MenuItem("Выход.", new Exit(), rootMenu);
    ...
    private Menu orderMenu() {
        ...
        orderMenuItems[7] = new MenuItem("Выход.", new Exit(), rootMenu);
    ...
    private Menu requestMenu() {
        ...
        requestMenuItems[5] = new MenuItem("Выход.", new Exit(), rootMenu);
    ...
    private Menu storageMenu() {
        ...
        storageMenuItems[5] = new MenuItem("Выход.", new Exit(), rootMenu);
